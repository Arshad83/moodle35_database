...
class __Mustache_cad7044148596e5a14c6807b2d29bbfb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section99d92b53f44a318b259a75758f79f5b7($context, $indent, $value);
        // 'hascourses' inverted section
        $value = $context->find('hascourses');
        if (empty($value)) {
            
            $buffer .= $indent . '    <div class="justify-content-center text-center mt-5">
';
...
';
    ...
    private function section9381cee888212a03f8c5c6be55db5baa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionCc8731cc92fa72befa7fa0e220170625(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section9ad773a8c0343c1539a4eed963d3b9ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section99d92b53f44a318b259a75758f79f5b7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                <a class="nav-link active" href="#myoverview_courses_view_in_progress" data-toggle="tab">
';
                $buffer .= $indent . '                    ';
                // 'str' section
                $value = $context->find('str');
...
';
                $buffer .= $indent . '            <li class="nav-item">
';
                $buffer .= $indent . '                <a class="nav-link" href="#myoverview_courses_view_future" data-toggle="tab">
';
                $buffer .= $indent . '                    ';
                // 'str' section
                $value = $context->find('str');
...
';
                $buffer .= $indent . '            <li class="nav-item">
';
                $buffer .= $indent . '                <a class="nav-link" href="#myoverview_courses_view_past" data-toggle="tab">
';
                $buffer .= $indent . '                    ';
                // 'str' section
                $value = $context->find('str');
...
';
                $buffer .= $indent . '        <div class="tab-pane active fade show" id="myoverview_courses_view_in_progress">
';
                // 'inprogress' section
                $value = $context->find('inprogress');
                $buffer .= $this->section9381cee888212a03f8c5c6be55db5baa($context, $indent, $value);
                // 'inprogress' inverted section
                $value = $context->find('inprogress');
                if (empty($value)) {
                    
                    $buffer .= '                <div class="justify-content-center text-center mt-5">
';
                    $buffer .= $indent . '                    <img class="empty-placeholder-image-lg"
';
                    $buffer .= $indent . '                         src="';
...
';
                ...
                $buffer .= $this->sectionCc8731cc92fa72befa7fa0e220170625($context, $indent, $value);
...
';
                ...
                $buffer .= $this->section9ad773a8c0343c1539a4eed963d3b9ce($context, $indent, $value);
