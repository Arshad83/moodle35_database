...
class __Mustache_e927f7656cdaba0937365699d4d14757 extends Mustache_Template
{
...
';
        // 'output.should_display_navbar_logo' section
        $value = $context->findDot('output.should_display_navbar_logo');
        $buffer .= $this->sectionB0f62ca6b7248adc1a2acfaa967d08a2($context, $indent, $value);
...
';
    ...
    private function sectionB0f62ca6b7248adc1a2acfaa967d08a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
