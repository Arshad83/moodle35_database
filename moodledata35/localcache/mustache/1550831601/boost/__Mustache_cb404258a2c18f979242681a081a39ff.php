...
class __Mustache_cb404258a2c18f979242681a081a39ff extends Mustache_Template
{
...
';
        // 'hascontrols' section
        $value = $context->find('hascontrols');
        $buffer .= $this->sectionB406719bc2cb0952c116712f7620115b($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionB406719bc2cb0952c116712f7620115b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="block-controls pull-right header">
';
                $buffer .= $indent . '                ';
