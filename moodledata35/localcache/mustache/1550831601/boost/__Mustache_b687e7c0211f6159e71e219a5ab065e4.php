...
class __Mustache_b687e7c0211f6159e71e219a5ab065e4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'blockD81bf1961f58dc00c27986be4b16fbe3'),
                ...
                'headeractions' => array($this, 'blockD5bf9ad5175f74ed47bb154634c315e5'),
                'content' => array($this, 'block7e3f15612160e3fe1762f99ffc9995a1'),
            ));
...
';
    ...
    public function blockD81bf1961f58dc00c27986be4b16fbe3($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        // 'pix' section
...
';
    ...
    public function blockD5bf9ad5175f74ed47bb154634c315e5($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block7e3f15612160e3fe1762f99ffc9995a1($context)
    {
        $indent = $buffer = '';
